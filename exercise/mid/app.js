...
db.query("CREATE TABLE IF NOT EXISTS posts (id INTEGER PRIMARY KEY AUTOINCREMENT, title TEXT, body TEXT, image MEDIUMBLOB)");
...
async function create(ctx) {
  ...
  if (body.type === "form") {
    ...
    db.query("INSERT INTO posts (title, body, image) VALUES (?, ?, ?)", [post.title, post.body, post.image]);
